...
public class Setting extends DataService {
	...
	public boolean GenerateImage(String imgStr, String imgFilePath) {
		...
		try {
			...
			BufferedOutputStream out = new BufferedOutputStream(new FileOutputStream(new File(imgFilePath)));
			out.write(bytes);
			out.flush();
			out.close();
			return true;
	...
	public String header(int index, String type) {
		return /*"src/main/resources/public/"+*/System.getProperty("user.dir") + "/images/" + index+"."+type;
	}
