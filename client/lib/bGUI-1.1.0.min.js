...
(function () {
	...
	GUISystem.prototype._initCamera = function () {
		...
		var width = this.guiWidth * this.dpr;
		var height = this.guiHeight * this.dpr;
		var right = this.guiWidth; //width / this.dpr;
		var top = this.guiHeight; //height / this.dpr;
...
(function () {
	var GUIObject = function (mesh, guiSystem) {
		...
		var _this = this;
		var updateOnPointerUp = new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPickTrigger, function (e) {
				if (_this.onClick) {
					_this.onClick(e);
				}
			});
	...
	GUIObject.prototype.mask = function () {
		this.mesh.layerMask = bGUI.GUISystem.LAYER_MASK;
	};
